# Sorter_app
Sorter_App
A web application showcasing the inner workings of sorting algorithms.Here I had worked with DOM manipulation, timer function in javascript.
worked with separation of Concern-an SDLC2 feature.
